...
&ensp;&ensp;为了快速历史性的观念去正确的看待RAM的价格，在非常早期的计算机中，有一种基于CRT屏幕点的内存非常昂贵，每bit大概$1。

## 定义
&ensp;&ensp;我将从我所观察到的不同使用场景来定义“文件系统”的含义。请注意，当我试图去符合标准的官方含义时，我其实是想基于它的各种不同用法去定义它。这些含义将在文章的剩余部分更加细致的探讨。
